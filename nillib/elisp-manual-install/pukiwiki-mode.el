...
;; modified by Shunsuke Aki is taged as ;;; EDITED. search "EDITED" for my modification.
...
;edited to make the middle column in pukiwiki-index wider, but only fialed. (defcustom pukiwiki-view-comment-form-comment-field-width 60
...
(defun pukiwiki-check-encode-able (beg end)
  ...
  (save-excursion
    (let* (
      ...
      ;;結果の表示
;;; EDITED http://d.hatena.ne.jp/yambi/20091106/1257522882
;;      (if (< 0 mycount)
      ...
      (while (setq pos
        ...
        (setq result
              (replace-match
               ...
               t t result)))
;;; EDITED ref. http://i-yt.info/?date=1121
