...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(aw-leading-char-face ((t (:background "yellow" :foreground "blue4" :box nil :height 280 :family "monaco"))))
