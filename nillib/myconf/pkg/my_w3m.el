...
;;;; for SEMI
      ...
      (setq w3m-content-type-alist
            (append
             (list '("text/html" "^/\\(home|Users\\)" w3m-browse-url nil))
             (list '("text/html" "^file.*www.cppreference.com.*" w3m-browse-url nil))
             (list '("application/xhtml+xml" "^file.*www.cppreference.com.*" w3m-browse-url "text/html"))
             (list '("text/html" "^file://localhost/.*" w3m-browse-url nil))
