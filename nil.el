...
;; == EMACS::CUSTOM ==
(let ((file (format "~/.emacs-custom-%s-%s.el" window-system emacs-major-version)))
...
;(load-library "my_highlight-indent-guides") ; This line breaks indentation even only by moving cursor.
